...
export interface ApiAddressAddress extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    buildingNo: Schema.Attribute.Integer & Schema.Attribute.Required;
    moreInfo: Schema.Attribute.Text;
    phone: Schema.Attribute.String & Schema.Attribute.Required;
    email: Schema.Attribute.String & Schema.Attribute.Required;
    government: Schema.Attribute.Enumeration<
      [
        'Alexandria',
        'Aswan',
        'Assiut',
...
export interface ApiCoachCoach extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coach_times: Schema.Attribute.Relation<
      'manyToMany',
...
export interface ApiCoachTimeCoachTime extends Struct.CollectionTypeSchema {
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    email: Schema.Attribute.String & Schema.Attribute.Required;
    prodDocId: Schema.Attribute.String;
    coachDocId: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    cardNumber: Schema.Attribute.Integer;
    cardHolder: Schema.Attribute.String;
    cardExpiryDate: Schema.Attribute.Date;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    freeShipping: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    shippingPrice: Schema.Attribute.Decimal & Schema.Attribute.Required;
    discountPrecent: Schema.Attribute.Decimal;
...
export interface ApiVoucherVoucher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isUsed: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    usageDate: Schema.Attribute.Date;
    email: Schema.Attribute.String & Schema.Attribute.Required;
    isExpired: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::coach-time.coach-time': ApiCoachTimeCoachTime;
